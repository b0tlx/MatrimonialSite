...
<nav class="homehead border-bottom">
    ...
    <h5 class="ps-2 text-dark">B L I S S  B O N D </h5>
        ...
        <div>
            ...
            <li class="nav-item"><a  class="nav-link  link-body-emphasis" href="Profile.jsp" action="RegisterServlet"> <h5>Profile <i class="fa-solid fa-id-badge fa-xs" style="color: #000000;"></i></h5></a></li>
    ...
    <header class="container d-flex flex-wrap gap-5">
        ...
        <section >
            ...
            <div class="box d-flex flex-wrap">
                ...
                <div class="pic ps-2 ps-md-0">
                    <img src="https://photosvibe.in/wp-content/uploads/cute-girl-pic14.jpg" alt="">
                </div>
                <div class="ps-3 pt-3 pt-md-0">
                    <p>Name : Riya Deshmuhk.</p>
                    <p>Age : 26</p>
                    <p>Contact : +91 8942572545</p>
                    <p>City : Delhi.</p>
                    <p>Gender : Female</p>
                   ...
                   <div class="d-flex justify-content-end gap-4">
                    ...
                    <a href="WomanOne.jsp" class="btn btn-light border"> View Profile</a>
                   </div>
             ...
             <div class="box d-flex flex-wrap">
                ...
                <div class="pic ps-2 ps-md-0">
                    <img src="https://photosvibe.in/wp-content/uploads/cute-girl-pic4.jpg" alt="">
                </div>
                <div class="ps-3 pt-3 pt-md-0">
                    <p>Name : Aditi Patil.</p>
                    <p>Age : 25</p>
                    <p>Contact : +91 6359741287</p>
                    <p>City : mumbai.</p>
                    <p>Gender : Female</p>
                   ...
                   <div class="d-flex justify-content-end gap-4">
                    ...
                    <a href="Plus.jsp" class="btn btn-light border" > Chat <i class="fa-regular fa-envelope fa-sm" style="color: #000000;"></i> </a>
                    <a href="WomanTwo.jsp" class="btn btn-light border"> View Profile</a>
                   </div>
